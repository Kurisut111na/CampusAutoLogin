...
Q_CONSTINIT const QMetaObject ConfigManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSConfigManagerENDCLASS_t,
        ...
        // method 'configLoaded'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const AppConfig &, std::false_type>,
        // method 'configError'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void ConfigManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->configLoaded((*reinterpret_cast< std::add_pointer_t<AppConfig>>(_a[1]))); break;
        case 2: _t->configError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ConfigManager::*)(const AppConfig & );
        ...
        }
        {
            ...
            if (_t _q_method = &ConfigManager::configError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void ConfigManager::configLoaded(const AppConfig & _t1)
{
