...
func initWindowWithCfg(cfg *windowCfg) error {
	...
	if atomic.CompareAndSwapUint32(&initedWalk, 0, 1) {
		...
		initCtrls.DwICC = win.ICC_BAR_CLASSES | win.ICC_LINK_CLASS | win.ICC_LISTVIEW_CLASSES | win.ICC_PROGRESS_CLASS | win.ICC_TAB_CLASSES | win.ICC_TREEVIEW_CLASSES | win.ICC_WIN95_CLASSES
